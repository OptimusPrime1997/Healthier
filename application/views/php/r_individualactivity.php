			...
			<div class="row ">
				<div class="box ">
					...
					<div class="col-md-2 col-lg-2 col-md-offset-3 col-lg-offset-3 m_inline text-center">
						<img class="image100" src="../img/profile.png">
						<h5>OptimusPrime</h5>
					</div>
					...
					<div class="col-md-2 col-lg-2  m_inline">
						<div class="text-center">
							<img class="image100" src="../img/question.png">
			...
			<div class="row ">
				<div class="box">
					<div class="col-md-5 col-lg-5 m_inline">
						<img class="image50 m_inline" src="../img/time.png">
						<div class="m_inline">
					...
					<div class="col-md-5 col-lg-5 col-md-offset-2 col-lg-offset-2 m_inline">
						<img class="image50 m_inline" src="../img/money.png">
						<div class="m_inline">
						<span>
			...
			<div class="row ">
				<div class="box">
					...
					<div class="col-md-5 col-lg-5">
						...
						<img class="image100 m_inline" src="../img/run2.png">
						<div class="m_inline">
						<span>
