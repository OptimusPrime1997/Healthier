					...
					<div id="activityTable">
						<table class="table table-bordered table-hover text-center" id="activityData">
							...
							<tr>
								...
								<th style="cursor: pointer" class="text-center">Sport <b>Type</b></th>
								<th style="cursor: pointer" class="text-center">Time to Start</th>
								<th style="cursor:pointer" class="text-center">Activity <b>Type</b></th>
								<th style="cursor:pointer" class="text-center">Orangnizer</th>
							</tr>
							</thead>
							<tbody>
							<tr>
             ...
             <?php if (!empty($allactivitylist)) {
				 ...
				 echo 0;
						...
						<a href="#"
						   ...
						   aria-selected="false"
						   role="tab"
						   value="Joinedactivity">
							Joined Race
							<span class="counter">
            <?php if (!empty($joinedactivitylist)) {
				echo count($joinedactivitylist);
			} else {
				echo 0;
			} ?>
          </span>
						...
						<a href="#"
						   ...
						   value="Myactivity">
							My Race
							<span class="counter">
            <?php if (!empty($myactivitylist)) {
				echo count($myactivitylist);
			} else {
				echo 0;
			} ?>
          </span>
					...
					jQuery(function ($) {
						...
						$(".underline-nav-item").click(function () {
							if (!$(this).hasClass('selected')) {
								...
								// alert(temp+" -- "+$('#'+temp).attr('value')+" is value");
				...
				<div class="display-container" id="Allactivity">
					<?php if (!empty($allactivitylist)) {
						...
						<span class="user-Foinedactivity-container js-toggler-container js-social-container on">
						  ...
						  <span class="follow <?php if (in_array($row, $myactivitylist)||in_array($row,$joinedactivitylist)) {
							  echo 'hidden';
						  } else {
						  ...
						  <span class="unfollow hidden">
							<!-- '"` --><!-- </textarea></xmp> -->
							  ...
							  <form accept-charset="UTF-8"
									action="<?php echo base_url('/controller_impl/race_controller/leave'); ?>"
									data-form-nonce="66033770d550dc277e426c8ecdcc013da1d43bab" data-remote="true"
									method="post"><div
									  style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden"
																					   value="&#x2713;"/><input
				...
				<div class="display-container hidden" id="Joinedactivity">
					<?php if (!empty($joinedactivitylist)) {
						foreach ($joinedactivitylist as $row): ?>
							<div
...
<input name="Race_name" value="<?php echo $row['race_name']; ?>" type="hidden">
				...
				<div class="display-container hidden" id="Myactivity">
					<?php if (!empty($myactivitylist)) {
						foreach ($myactivitylist as $row): ?>
							<div
								class="d-table col-12 width-full py-4 border-bottom border-gray-light ">
								<div class="d-table-cell col-1 v-align-top">
									<a href="/14dtj"><img alt="@<?php echo $row['account_id']; ?>"
						...
						<span class="user-Foinedactivity-container js-toggler-container js-social-container on hidden">
